    ...
    >
      <div className="mx-auto h-full px-6">
        <nav className="flex items-center justify-between h-full">
          ...
          >
            <img src="/lovable-uploads/c1103db7-0674-4ea8-baef-90db149e421e.png" alt="Kaptick Logo" className="w-8 h-8" />
            <span className="font-bold text-base">Kaptick Media</span>
          </a>
